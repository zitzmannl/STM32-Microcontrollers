...
int main(void)
{
  ...
  if (key != last_key){
	 // Blue LED Logic
	  ...
	  if (key == '1'){
		  Blink_LED(GPIOD, GPIO_PIN_12, 1);
	  } else if (key == '2'){
		  Blink_LED(GPIOD, GPIO_PIN_13, 1);
	  } else if (key == '3'){
		  Blink_LED(GPIOD, GPIO_PIN_14, 1);
	  } else if (key == '4'){
		  Blink_LED(GPIOD, GPIO_PIN_12, 2);
	  } else if (key == '5'){
		  Blink_LED(GPIOD, GPIO_PIN_13, 2);
	  } else if (key == '6'){
		  Blink_LED(GPIOD, GPIO_PIN_14, 2);
	  } else if (key == '7'){
		  Blink_LED(GPIOD, GPIO_PIN_12, 4);
	  } else if (key == '8'){
		  Blink_LED(GPIOD, GPIO_PIN_13, 4);
	  } else if (key == '9'){
		  Blink_LED(GPIOD, GPIO_PIN_14, 4);
	  } else if (key == '0'){
